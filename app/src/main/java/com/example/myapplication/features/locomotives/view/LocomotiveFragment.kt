...
class LocomotiveFragment : Fragment() {
    private var searchJob: Job? = null
    private val vm: LocomotivesVM by viewModel()
    private lateinit var adapter: LocomotiveAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = LocomotiveAdapter(requireFragmentManager())
    ...
    companion object {
        @JvmStatic
        fun newInstance() = LocomotiveFragment()
    }
    ...
    public fun loadItems(query: String = "") {
        ...
        searchJob = lifecycleScope.launch {
            vm.getLocomotives(query).collectLatest { pagingData ->
